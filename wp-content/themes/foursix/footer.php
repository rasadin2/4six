...
?>
	...
	<?php 
		/**
		 * foursix_before_footer hook
		 */
		do_action( 'foursix_before_footer' );
	?>

	<footer class="foursix-footer bottom-footer">
		<!-- Widgets -->
	...
	<?php  
		/**
		 * foursix_after_footer hook
		 */
		do_action( 'foursix_after_footer' );
	?>
</div><!-- #page -->
