...
```php
foursix_popup_register_settings()
...
**Helper Function**
```php
foursix_get_popup_option( $key, $default )
...
```javascript
const CONFIG = {
    showDelay: foursixPopupSettings.showDelay || 1500
}
```
...
All settings stored with prefix `foursix_popup_*`:

```
foursix_popup_alert_text
foursix_popup_title
foursix_popup_bonus_label
foursix_popup_bonus_amount
foursix_popup_bonus_extra
foursix_popup_bonus_subtitle
foursix_popup_bonus_info
foursix_popup_feature1_title
foursix_popup_feature1_subtitle
foursix_popup_feature2_title
foursix_popup_feature2_subtitle
foursix_popup_feature3_title
foursix_popup_feature3_subtitle
foursix_popup_button_text
foursix_popup_button_url
foursix_popup_show_delay
foursix_popup_enable_auto_show
foursix_popup_bg_gradient_start
foursix_popup_bg_gradient_end
foursix_popup_primary_color
foursix_popup_text_color
```
...
- **Helper function**: `foursix_get_popup_option()`
