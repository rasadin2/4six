		...
		<div class="col-md-9">
			<div id="primary" class="foursix-content-area">
				...
				if ( have_posts() ) :
					...
					/**
					 * foursix_before_post_pagination hook
					 */
					do_action( 'foursix_before_post_pagination' );

					// the_posts_navigation();
					echo paginate_links(array(
						'prev_text' => esc_html__('Prev', 'foursix'),
						'next_text' => esc_html__('Next', 'foursix')
					));

					/**
					 * foursix_after_post_pagination hook
					 */
					do_action( 'foursix_after_post_pagination' );
