...
if( !class_exists( 'Foursix_WooCommerce' ) ) :

    /**
     * The Foursix WooCommerce Integration Class
     */
    class Foursix_WooCommerce {
        ...
        /**
         * Foursix WooCommerce Scripts
         * 
         * @since 1.0.0
         */
        public function woocommerce_scripts() {
		    wp_enqueue_style( 'foursix-woo-style', get_template_directory_uri() . '/woocommerce.css' );  
        }
		...
		public function related_products_args( $args ) {
			$args = apply_filters( 'foursix_related_products_args', array(
				'posts_per_page' => 3,
				'columns'        => 3,
			) );
...
return new Foursix_WooCommerce();