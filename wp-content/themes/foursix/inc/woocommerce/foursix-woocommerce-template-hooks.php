...
if( ! class_exists( 'Foursix_WooCommerce_Hooks' ) ) :

    class Foursix_WooCommerce_Hooks {
        ...
        /**
         * foursix WooCommerce Theme Support
         */
...
return new Foursix_WooCommerce_Hooks();
